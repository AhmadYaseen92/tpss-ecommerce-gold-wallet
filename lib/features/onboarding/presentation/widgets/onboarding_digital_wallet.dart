...
class OnboardingDigitalWalletPage extends StatelessWidget {
  const OnboardingDigitalWalletPage({super.key,required this.cubit});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Store gold, silver, and jewelry securely in your digital wallet',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 18,
