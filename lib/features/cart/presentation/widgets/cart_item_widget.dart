            ...
            child: Row(
              children: [
                ClipRRect(
                  ...
                  child: Image.network(product.imageUrl, width: 84, height: 84, fit: BoxFit.cover),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(product.name, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: palette.textPrimary)),
