...
List<NotificationModel> todayNotifications = [
  NotificationModel(
    ...
    icon: const Icon(Icons.trending_up, color: Colors.amber),
  ),
  NotificationModel(
    ...
    icon: const Icon(Icons.account_balance, color: Colors.teal),
  ),
  NotificationModel(
...
List<NotificationModel> weekNotifications = [
  ...
  NotificationModel(
    ...
    icon: const Icon(Icons.percent, color: Colors.grey),
  ),
  NotificationModel(
