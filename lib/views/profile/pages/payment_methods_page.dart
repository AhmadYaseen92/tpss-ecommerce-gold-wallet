    ...
    return BlocProvider(
      ...
      child: BlocBuilder<ProfileCubit, ProfileState>(
        builder: (context, state) {
          ...
          final selectedMethod = cubit.paymentMethods[state.selectedPaymentIndex];
                      ...
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final selected = index == state.selectedPaymentIndex;
                            return ChoiceChip(
                        ...
                        AppButton(
                          ...
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  '${selectedMethod.name} saved successfully',
                                ),
                              ),
                            );
                          },
