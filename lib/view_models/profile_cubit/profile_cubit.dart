...
class ProfileCubit extends Cubit<ProfileState> {
  ...
  void _initializeControllers() {
    ...
    _rebuildPaymentControllers(state.selectedPaymentIndex);
    _rebuildBankControllers(state.selectedBankIndex);
  }

  void toggleEdit() => emit(state.copyWith(isEditing: !state.isEditing));

  void save() => emit(state.copyWith(isEditing: false));
  ...
  void selectBiometric(String value) => emit(state.copyWith(selectedBiometric: value));
  void selectLanguage(String value) => emit(state.copyWith(selectedLanguage: value));
  void selectTheme(String value) => emit(state.copyWith(selectedTheme: value));
  void selectNationality(String value) => emit(state.copyWith(selectedNationality: value));
  void selectDocumentType(String value) => emit(state.copyWith(selectedDocumentType: value));
