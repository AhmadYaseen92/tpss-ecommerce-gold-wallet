...
<template>
  ...
  <Card title="Filters" subtitle="Only fields relevant to the selected report type are shown.">
    <div class="ui-filter-bar report-filters-grid">
      ...
      <FormField v-if="filters.reportType === 'fees'" label="Fee Type"><Select v-model="filters.feeType"><option value="all">All Fee Types</option><option value="delivery">Delivery Fee</option><option value="storage">Storage Fee</option><option value="service">Service Fee</option></Select></FormField>
