          ...
          rows = visibleInvoices.value
            ...
            .map((invoice) => {
              ...
              return {
                ...
                "Item Image": invoice.productImageUrl ?? "-",
                "Item Name": invoice.productName ?? "-",
                "Item SKU": invoice.productSku ?? "-",
                "Item Fees": invoice.feeDetails || fees,
                Weight: invoice.weight ?? 0,
                "Category / Material": invoice.category ?? "-",
                Quantity: invoice.quantity ?? 0,
                Purity: invoice.purity ?? "N/A",
                "Wallet Item Id": invoice.walletItemId ?? "-",
                "Sub Total": subTotal,
                Fees: fees,
                "VAT / Tax": tax,
                Discount: discount,
