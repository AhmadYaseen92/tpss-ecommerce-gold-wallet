...
class BottomBar extends StatelessWidget {
  ...
  const BottomBar({super.key, required this.onAddToCart, required this.onBuyNow, required this.productCubit});
        ...
        children: [
          Padding(
            ...
            child: BlocBuilder<ProductCubit, ProductState>(
              bloc: productCubit,
              buildWhen: (_, current) => current is ProductQuantityChanged || current is ProductDetailLoaded,
              builder: (context, state) {
                final quantity = productCubit.quantity;
                return Row(
